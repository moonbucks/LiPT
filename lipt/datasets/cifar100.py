...
def CIFAR100(data_path):
    ...
    dst_train = datasets.CIFAR100(data_path, train=True, download=True, transform=train_transform)
    dst_test = datasets.CIFAR100(data_path, train=False, download=True, transform=val_transform)
